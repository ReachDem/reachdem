...
export const ContactFieldSchema = z.union([
    ...
    z.string().regex(/^custom\.[a-zA-Z0-9_]+$/, "Custom fields must start with 'custom.' and contain alphanumeric key identifiers.")
]);
...
export const ConditionValueTypeSchema = z.enum(["string", "number", "date", "boolean"]);
