import { IconTrendingDown, IconTrendingUp, IconMessage, IconMail, IconUsers, IconPercentage } from "@tabler/icons-react"
    ...
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
      ...
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">8,234</CardTitle>
          <CardAction>
            <Badge variant="outline">
              <IconTrendingUp />
              +45%
        ...
        <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <div className="text-muted-foreground">+2,890 emails vs last month</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">4,567</CardTitle>
          <CardAction>
            <Badge variant="outline">
              <IconTrendingUp />
              +234
      ...
      <Card className="@container/card">
        <CardHeader>
          ...
          <CardTitle className="text-2xl font-semibold tabular-nums @[250px]/card:text-3xl">98.5%</CardTitle>
          <CardAction>
            <Badge variant="outline">
              <IconTrendingUp />
              +1.2%
