...
export default function ApiConfigPage() {
  ...
  const [apiBaseUrl, setApiBaseUrl] = useState("https://api.reachdem.com");
  const [activeLang, setActiveLang] = useState<
    "cURL" | "JavaScript" | "Python" | "PHP"
  >("cURL");
  const [defaultIdemp, setDefaultIdemp] = useState("idemp_a1b2c3d4");
  ...
  -H "Idempotency-Key: ${defaultIdemp}" \\
  -d '{
    "type": "transactional",
    "channel": "sms",
    "to": "+1234567890",
  ...
  const EndpointRow = ({
    ...
    return (
      <div className="border-border/50 hover:bg-muted/10 flex flex-col border-b transition-colors last:border-0">
        ...
        >
          <span
            className={`rounded-[4px] border px-2 py-0.5 font-mono text-[11px] ${methodColors[method]} w-14 shrink-0 text-center font-semibold tracking-wide`}
          >
            {method}
          </span>
            ...
            <div id="messages" className="scroll-mt-24">
              ...
              <div className="border-border/50 bg-card flex flex-col overflow-hidden rounded-xl border shadow-sm">
                <EndpointRow
                  method="GET"
                  path="/v1/messages"
                  description="List all messages (supports ?cursor)"
                  payload={
                    "// No request body needed\n// Used for retrieving a paginated list of sent messages"
                  }
                />
                <EndpointRow
                  method="GET"
                  path="/v1/messages/:id"
                  description="Retrieve a specific message via ID"
                ...
                <EndpointRow
                  ...
                  payload={
                    '{\n  "type": "transactional",\n  "channel": "sms", // sms | whatsapp | email\n  "to": "+1234567890",\n  "senderId": "ReachDem", // Optional sender alias\n  "content": "Your Verification Code is: 4321"\n}'
                  }
                />
              </div>
            </div>
            ...
            <div id="contacts" className="scroll-mt-24">
              ...
              <div className="border-border/50 bg-card flex flex-col overflow-hidden rounded-xl border shadow-sm">
                ...
                <EndpointRow
                  method="PUT"
                  path="/v1/contacts/:id"
                  description="Update a contact fully"
                  payload={
                    '{\n  "email": "jane.updated@example.com",\n  "tags": ["voter", "district_9", "donor"]\n}'
                  }
                />
                <EndpointRow
                  method="DELETE"
            ...
            <div id="campaigns" className="scroll-mt-24">
              ...
              <div className="border-border/50 bg-card flex flex-col overflow-hidden rounded-xl border shadow-sm">
                ...
                <EndpointRow
                  ...
                  payload={
                    '{\n  "name": "Spring Get Out The Vote",\n  "channel": "sms",\n  "segmentId": "seg_xyz789",\n  "content": "Election Day is tomorrow! Don\'t forget to vote.",\n  "scheduleDate": "2024-11-04T09:00:00Z"\n}'
                  }
                />
                <EndpointRow
                  method="GET"
                ...
                <EndpointRow
                  method="DELETE"
                  path="/v1/campaigns/:id"
                  description="Delete a campaign draft"
                  payload={"// No request body needed"}
                />
                <EndpointRow
                  method="POST"
                  path="/v1/campaigns/launch"
                  description="Launch a scheduled campaign"
