...
import { uploadToR2, generateProfilePhotoKey, generateOrgAvatarKey, validateImageFile } from "@/lib/r2";
...
export async function POST(request: NextRequest) {
    try {
        ...
        if (!uploadType || (uploadType !== "user" && uploadType !== "organization")) {
            return NextResponse.json(
        ...
        const key = uploadType === "organization" 
